...
namespace KamiJal.CoupleMatch.LanguagePack
{
    public sealed class ReportEn : Report
    {
        ...
        {
            Text = $"{name}, you are successfully registered!";
        }

        public override void AlreadyRegistered(string name)
        {
            Text = $"{name}, you are already registered!";
        }

        public override void NotRegistered()
        {
            Text = "You are not registered! Send /register to register yourself.";
        }
        ...
        {
            Text = "Please send photo in good quality where you are alone!";
        }
        ...
        {
            Text = "Please send photo before searching couple!";
        }

        public override void PhotoAlreadyRegistered()
        {
            Text = "You have already registered your photo!";
        }

        public override void NoMatchesFound()
        {
            Text = "Unfortunately, no matching couple was found!";
        }

        public override void MatchesFound()
        {
            Text = "Matching people were found!";
        }
    }
}